# This script builds and bundles a macOS .app for a Qt application named "Kakeibo".
#
...
#     - Creates a .app bundle named "Kakeibo.app"
#     - Converts assets/appIcon/icon.png into icon.icns and includes it
#     - Copies the compiled binary (default: Kakeibo) into the bundle
...
#
# - Result:
#     - A clean repo, unchanged except for the newly added Kakeibo.app bundle
#     - Ready to run via: open "Kakeibo.app"
#
# - Requirements:
#     - Qt’s macdeployqt must be in your PATH
#     - CMakeLists.txt must produce a binary named "Kakeibo"
...
<dict>
	...
	<string>com.colincle.$APP_NAME</string>
